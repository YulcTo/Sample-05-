...
public class Program
{
    ...
    //public static void Main(string[] args)//Hanson06
    //{
    //    int number = 0;
 ...
 public static void Main() // LINQ
    {
        ...
        //すべての要素数が二倍になる
        //var doubled = elements.Select(s => s * 2);
        //foreach (var s in doubled)
        //{
        //    Console.WriteLine(s);
        //}
        ////文字列に変換
        //var stringfy = elements.Select(t => t.ToString());
        //foreach (var t in stringfy)
        //{
        //    Console.WriteLine(t);
        //}
        ////数値の値で集合を並び変える
        //var sorted = elements.OrderBy(o =>o );
